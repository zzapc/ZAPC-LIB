...
class ZCL_AP_SHMA_AREA definition
  public
...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'ZCL_AP_SHMA_AREA' ##NO_TEXT.
  data ROOT type ref to ZCL_AP_SHMA_ROOT read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to ZCL_AP_SHMA_AREA
    raising
      CX_SHM_INCONSISTENT
...
endclass. "ZCL_AP_SHMA_AREA definition
class ZCL_AP_SHMA_AREA implementation.
