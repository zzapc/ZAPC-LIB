      ...
      WHEN 'DESCARGAR'.
        ...
        cl_gui_frontend_services=>directory_browse(
          ...
          EXCEPTIONS
            ...
            OTHERS               = 4 ).
        IF sy-subrc <> 0.
          MESSAGE 'Error seleccionando directorio' TYPE 'I'.
        ENDIF.
...
*    o_alv->set_top_of_page( ).
  ...
  IMPORTING
    ...
    IF NOT l_cliente IS INITIAL.
      ASSIGN info_xlsx[ name = l_cliente ] TO FIELD-SYMBOL(<info_xlsx>).
      IF sy-subrc = 0.
        o_ms->get_rango_worksheet(
    EXPORTING
      id              = <info_xlsx>-id
  ...
  METHOD insert_docs.
    ...
    LOOP AT i_valores ASSIGNING FIELD-SYMBOL(<val>) WHERE fila > 1 AND columna = 1 AND valor <> ''. " TCODE
      ...
      LOOP AT i_valores ASSIGNING FIELD-SYMBOL(<val2>) WHERE fila = <val>-fila AND columna > 1 AND valor <> ''.
        CASE <val2>-columna.
      ...
      IF    l_listado_bd-fichero       <> l_listado-fichero
         OR l_listado_bd-clasificacion <> l_listado-clasificacion
         OR l_listado_bd-permisos      <> l_listado-permisos
         OR l_listado_bd-descripcion   <> l_listado-descripcion
         OR l_listado_bd-boton         <> l_listado-boton
         OR l_listado_bd-extension     <> l_listado-extension.
