...
*
* Download files *
FORM download USING srcpath LIKE draw-filep
                    dstpath LIKE draw-filep
                    file    LIKE draw-filep.
...
* Upload file *
FORM upload USING srcpath LIKE draw-filep
                  dstpath LIKE draw-filep
                  file    LIKE draw-filep.
  DATA BEGIN OF buffer OCCURS 0.
  DATA   DATA(1024) TYPE x.
...
* Write file to server *
  ...
  ELSE.
    WRITE: / 'No existe fichero', filename.
  ENDIF.
